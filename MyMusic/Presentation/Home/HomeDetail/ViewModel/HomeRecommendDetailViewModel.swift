//
//  HomeRecommendDetailViewModel.swift
//  MyMusic
//
...
protocol HomeRecommendDetailViewModelInput {
    func viewDidLoad(_ observable: Observable<Void>)
    func didSelectTrack(at index: Int)
}

protocol HomeRecommendDetailViewModelOutput {
...
protocol HomeRecommendDetailViewModel: HomeRecommendDetailViewModelInput,
                                       HomeRecommendDetailViewModelOutput,
                                       HomeDetailTableViewDataSource { }

final class DefaultHomeRecommendDetailViewModel: HomeRecommendDetailViewModel {
    
    private let disposeBag = DisposeBag()
    private let albumInfo: MusicPersonalRecommendation.Item
    ...
    init(item: MusicPersonalRecommendation.Item) {
        self.albumInfo = item
    }
...
extension DefaultHomeRecommendDetailViewModel {
...
extension DefaultHomeRecommendDetailViewModel: HomeDetailTableViewDataSource {
